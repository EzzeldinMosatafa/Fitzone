      ...
      <div className="flex-1 flex">
        ...
        <div className="w-64 bg-blue-600 dark:bg-gray-800 text-white min-h-screen p-4 hidden md:block">
          <div className="space-y-4">
            ...
            <Link to="/user/saved-videos" className="flex items-center space-x-2 p-2 hover:bg-blue-700 dark:hover:bg-gray-700 rounded transition">
              <FontAwesomeIcon icon={faVideo} />
              <span>Saved Videos</span>
            </Link>
            <Link to="/user/liked-videos" className="flex items-center space-x-2 p-2 bg-blue-700 dark:bg-gray-700 rounded">
        ...
        <div className="flex-1 bg-[#F5F5F5] dark:bg-gray-900 p-8">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-3xl font-bold mb-8 dark:text-white">Liked Videos</h1>
            ...
            {likedVideos.length === 0 && !loading && !error ? (
              <div className="text-center py-12">
                <FontAwesomeIcon icon={faHeart} className="text-6xl text-gray-400 dark:text-gray-600 mb-4" />
                <h2 className="text-2xl font-semibold text-gray-600 dark:text-gray-400 mb-2">No Liked Videos</h2>
                <p className="text-gray-500 dark:text-gray-500 mb-6">
                  You haven't liked any videos yet. Start exploring our workout library!
                </p>
                <Link 
                  to="/workoutlibrary" 
